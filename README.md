...
Clone this [repository](https://github.com/ohyajk/Decode-Morse-Code.git) to your desired folder:

```sh
  cd my-folder
  git clone https://github.com/ohyajk/Decode-Morse-Code.git 
...
Feel free to check the [issues page](https://github.com/ohyajk/Decode-Morse-Code/issues).
